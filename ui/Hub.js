...
const SECTION_ORDER = ["keyboard", "capture", "appearance", "plugins", "system"]
const SECTION_LABELS = { keyboard: "Keyboard", capture: "Capture", appearance: "Appearance", plugins: "Plugins", system: "System" }
const SECTION_ICONS = { keyboard: "󰌌", capture: "󰄄", appearance: "󰏘", plugins: "󰐱", system: "󰒓" }
